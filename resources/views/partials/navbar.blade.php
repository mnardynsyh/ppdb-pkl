...
>
    <div class="max-w-screen-2xl mx-auto px-6 py-3 flex items-center justify-between">
            ...
            <div x-data="{ open: false }" class="relative">
                <button 
                    ...
                    :class="activeMenu.startsWith('info') 
                        ? 'bg-blue-50 text-blue-700' 
                        : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'"
                    class="flex items-center space-x-1.5 px-5 py-2.5 rounded-lg font-medium text-sm transition-all duration-200"
                >
                    <span>Informasi</span>
        ...
        <div class="flex items-center space-x-4">
            <!-- Login Button -->
            <a href="{{ route('login') }}"
                class="hidden md:flex items-center space-x-2 bg-gray-900 hover:bg-gray-800 text-white px-5 py-2.5 rounded-lg font-medium text-sm transition-colors duration-200 shadow-sm"
            >
            ...
            <button 
                @click="toggleMobile()"
                class="lg:hidden w-10 h-10 flex items-center justify-center rounded-lg text-gray-600 hover:bg-gray-100 transition-colors duration-200 border border-gray-300"
            >
    ...
    <div 
        ...
        class="lg:hidden absolute top-full left-0 w-full bg-white border-b border-gray-200 shadow-lg"
    >
        <div class="px-6 py-4 space-y-3">
            ...
            <div class="pt-4 border-t border-gray-200">
                <a href="{{ route('login') }}" 
                   @click="toggleMobile()"
                   class="flex items-center justify-center space-x-2 bg-gray-900 text-white px-4 py-3 rounded-lg font-medium text-sm transition-colors duration-200"
                >
