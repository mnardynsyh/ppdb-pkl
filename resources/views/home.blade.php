...
{{-- Hero Section --}}
<section class="bg-gradient-to-br from-white via-white to-[#fefae0]/30" style="font-family: 'Poppins', sans-serif;">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 min-h-[85vh] items-center">
        ...
        <div class="mr-auto place-self-center lg:col-span-7" data-aos="fade-right">
            {{-- [DIPERBARUI] Font weight diubah ke 'font-bold' dan ukuran xl dihilangkan untuk tampilan lebih clean --}}
            <h1 class="max-w-2xl mb-4 text-4xl font-bold tracking-tight leading-snug md:text-5xl text-[#283618]">
                Selamat Datang di PPDB Online <br>
                {{-- [DIPERBARUI] Aksen sorotan pada judul dihilangkan --}}
                SMP Muhammadiyah 1 Sirampog
            </h1>
            {{-- [DIPERBARUI] Font weight diubah ke 'font-light' untuk kesan lebih elegan --}}
            ...
            @if($statusInfo['status'] == 'Dibuka')
              <div data-aos="fade-up" data-aos-delay="200">
                <a href="{{ route('siswa.register') }}" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-[#bc6c25] hover:bg-[#a55d20] focus:ring-4 focus:ring-[#dda15e]/80 transition-colors duration-300">
                    Daftar Sekarang
                    <svg class="w-5 h-5 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </a>
                <a href="{{ route('jadwal')}}" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-[#283618] border border-[#606c38] rounded-lg hover:bg-[#dda15e]/40 focus:ring-4 focus:ring-[#dda15e]/50 transition-colors duration-300">
                    Lihat Jadwal
                </a> 
              </div>
            @endif
        ...
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex justify-center items-center" data-aos="fade-left">
            <img src="{{ asset('img/hero.png') }}" alt="Foto SMP Muhammadiyah 1 Sirampog" 
                 class="drop-shadow-xl w-full h-auto max-h-[500px] object-contain">
        </div>                
    </div>
</section>
