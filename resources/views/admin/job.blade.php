                        ...
                        <td class="px-6 py-2">
                            <div class="flex items-center gap-3">
                                <button type="button"
                                    ...
                                    class="text-white bg-yellow-400 hover:bg-yellow-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 mb-2">
                                    Edit
                                </button>
                                <form action="{{ route('admin.job.destroy', $job->id) }}" method="POST"
                                    ...
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="text-white bg-red-600 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2   ">
                                        Hapus
                                    </button>
                                </form>
                            </div>
...
<div id="addModal"
     ...
     aria-hidden="true">
    {{-- Card modal dipusatkan tanpa flex, jadi tidak konflik --}}
